module github.com/aejkcs50/seqdex/daemon

go 1.16

replace github.com/aejkcs50/seqdex/daemon/pkg/explorer => ./pkg/explorer

replace github.com/aejkcs50/seqdex/daemon/pkg/securestore => ./pkg/securestore

replace github.com/aejkcs50/seqdex/daemon/pkg/macaroons => ./pkg/macaroons

replace github.com/aejkcs50/seqdex/daemon/old-v0 => ./cmd/migration/v0-v1/v0-domain

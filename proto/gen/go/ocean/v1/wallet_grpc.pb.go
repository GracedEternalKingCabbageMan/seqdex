...
const (
	WalletService_GenSeed_FullMethodName        = "/ocean.v1.WalletService/GenSeed"
	WalletService_CreateWallet_FullMethodName   = "/ocean.v1.WalletService/CreateWallet"
	WalletService_Unlock_FullMethodName         = "/ocean.v1.WalletService/Unlock"
	WalletService_Lock_FullMethodName           = "/ocean.v1.WalletService/Lock"
	WalletService_ChangePassword_FullMethodName = "/ocean.v1.WalletService/ChangePassword"
	WalletService_RestoreWallet_FullMethodName  = "/ocean.v1.WalletService/RestoreWallet"
	WalletService_Status_FullMethodName         = "/ocean.v1.WalletService/Status"
	WalletService_GetInfo_FullMethodName        = "/ocean.v1.WalletService/GetInfo"
	WalletService_Auth_FullMethodName           = "/ocean.v1.WalletService/Auth"
)
...
type WalletServiceClient interface {
	...
	// encrypts them with the password and persists the encrypted seeds.
	RestoreWallet(ctx context.Context, in *RestoreWalletRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RestoreWalletResponse], error)
...
func (c *walletServiceClient) RestoreWallet(ctx context.Context, in *RestoreWalletRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RestoreWalletResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &WalletService_ServiceDesc.Streams[0], WalletService_RestoreWallet_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RestoreWalletRequest, RestoreWalletResponse]{ClientStream: stream}
...
type WalletService_RestoreWalletClient = grpc.ServerStreamingClient[RestoreWalletResponse]
...
type WalletServiceServer interface {
	...
	// RestoreWallet restores an HD Wallet based on signing and blinding seeds,
	// encrypts them with the password and persists the encrypted seeds.
	RestoreWallet(*RestoreWalletRequest, grpc.ServerStreamingServer[RestoreWalletResponse]) error
	// Status returns info about the status of the wallet.
...
func (UnimplementedWalletServiceServer) GenSeed(context.Context, *GenSeedRequest) (*GenSeedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenSeed not implemented")
}
...
func (UnimplementedWalletServiceServer) RestoreWallet(*RestoreWalletRequest, grpc.ServerStreamingServer[RestoreWalletResponse]) error {
	return status.Error(codes.Unimplemented, "method RestoreWallet not implemented")
}
...
func _WalletService_RestoreWallet_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(WalletServiceServer).RestoreWallet(m, &grpc.GenericServerStream[RestoreWalletRequest, RestoreWalletResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type WalletService_RestoreWalletServer = grpc.ServerStreamingServer[RestoreWalletResponse]

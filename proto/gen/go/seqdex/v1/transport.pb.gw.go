...
func request_TransportService_SupportedContentTypes_0(ctx context.Context, marshaler runtime.Marshaler, client TransportServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq SupportedContentTypesRequest
...
func RegisterTransportServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransportServiceServer) error {
	mux.Handle(http.MethodGet, pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/seqdex.v1.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v1/transport"))
		if err != nil {
...
// "TransportServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterTransportServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransportServiceClient) error {
	mux.Handle(http.MethodGet, pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/seqdex.v1.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v1/transport"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}

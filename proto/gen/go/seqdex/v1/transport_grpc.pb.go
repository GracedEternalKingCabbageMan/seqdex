...
const (
	TransportService_SupportedContentTypes_FullMethodName = "/seqdex.v1.TransportService/SupportedContentTypes"
)
...
func (c *transportServiceClient) SupportedContentTypes(ctx context.Context, in *SupportedContentTypesRequest, opts ...grpc.CallOption) (*SupportedContentTypesResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportService_SupportedContentTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTransportServiceServer should be embedded to have
...
func (UnimplementedTransportServiceServer) SupportedContentTypes(context.Context, *SupportedContentTypesRequest) (*SupportedContentTypesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SupportedContentTypes not implemented")
}
...
var TransportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "seqdex.v1.TransportService",
	...
	Metadata: "seqdex/v1/transport.proto",
}
